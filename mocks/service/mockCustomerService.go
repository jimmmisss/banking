...
// Source: github.com/jimmmisss/banking/service (interfaces: CustomerService)

// Package service is a generated GoMock package.
package service

import (
	dto "github.com/jimmmisss/banking/dto"
...
// GetByIdCustomer mocks base method.
func (m *MockCustomerService) GetByIdCustomer(arg0 string) (*dto.CustomerResponse, *errs.AppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByIdCustomer", arg0)
	ret0, _ := ret[0].(*dto.CustomerResponse)
	ret1, _ := ret[1].(*errs.AppError)
	return ret0, ret1
}

// GetByIdCustomer indicates an expected call of GetByIdCustomer.
func (mr *MockCustomerServiceMockRecorder) GetByIdCustomer(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByIdCustomer", reflect.TypeOf((*MockCustomerService)(nil).GetByIdCustomer), arg0)
}
